...
<script>
	function page(idx) {
		var pagenum = idx;
		var pagecount = 10;
		location.href = "/board?pagenum="+pagenum+"&pagecount="+pagecount;
	}
</script>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<table border="2" class="table table-condensed">
					<tr>
						<td colspan="5" align="right"><a href="/boardwrite">[새글쓰기]</a></td>
					</tr>
					<tr class="active">
						<td>NO</td>
						<td>제목</td>
					...
					<c:forEach items="${list}" var="boardDTO">
						<tr class="rows">
							...
							<td><a href="/boardview?board_idx=${boardDTO.board_idx}">${boardDTO.board_title}</a></td>
							<td>${boardDTO.name}</td>
							<td>${boardDTO.board_writetime}</td>
